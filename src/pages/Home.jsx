      ...
      <div className="p-4 md:p-8 lg:p-12 max-w-7xl mx-auto relative z-20">
        ...
        >
          ...
          <div className="mt-8 flex items-center justify-center gap-3 flex-wrap">
            <a
              href="https://www.instagram.com/isra_vatanappally/?utm_source=ig_web_button_share_sheet"
              target="_blank"
              rel="noreferrer"
              aria-label="ISRA Vatanappally Instagram"
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-x-8 gap-y-10 place-items-center max-w-6xl mx-auto px-4 mb-8">
          ...
          <div className="grid grid-cols-5 gap-x-6 gap-y-8 place-items-center max-w-6xl mx-auto px-4">
