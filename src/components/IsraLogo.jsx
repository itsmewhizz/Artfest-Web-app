...
const BG_START = 'rgb(40 114 161)' // Ocean Blue #2872A1
const BG_END = 'rgb(31 90 128)' // Deep Navy #1F5A80
const ACCENT = 'rgb(232 132 92)' // Sunset Coral #E8845C
const TEXT_LIGHT = 'rgb(234 244 250)' // #EAF4FA
const TEXT_MUTED = 'rgb(169 199 214)' // #A9C7D6
